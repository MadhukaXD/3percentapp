...
function ClientList() {
    ...
    return (
        ...
        //         </div>
        //         {ClientList.map((ClientList, key) => (
        //             <a href={"clientprofile?ClientList_id=" + ClientList._id}>
        //                 <div className="row" key={key}>
        //                     <div className="col-md-3">
        //                         <h6>{ClientList.FirstName} {ClientList.LastName}</h6>
        //                     </div>
        //                     <div className="col-md-2">
        ...
        //                     </div>
        //                     <div className="col-md-1">
        //                         <h6>{ClientList.Gender}</h6>
        //                     </div>
        //                     <div className="col-md-2">
        //                         <h6>{ClientList.Location}</h6>
        //                     </div>
        //                     <div className="col-md-2">
        //                         <h6>{ClientList.Date}</h6>
        //                     </div>
        //                 </div>
        //             </a>
        //         ))}
