                                                    ...
                                                    <div data-v-52fb9f55="" className="layout row wrap no-padding">
                                                        ...
                                                        <div data-v-52fb9f55="" className="flex py-none xs4 md4">
                                                            <div data-v-52fb9f55="" className="k-input k-input--has-changed"
                                                                ...
                                                                >
                                                                    {/* <div className="">
                                                                        <div data-v-52fb9f55="" className="flex md4 py-none text-xs-right xs4">
                                                                            <div className="k-toggle ma-auto">
                                                                                <input id="object-11" label=""
                                                                                    type="checkbox" />
                                                                                <label for="object-11" className="colorone--text tw-text-xs">
                                                                                    Any Major Injuries</label>
                                                                        ...
                                                                        <div data-v-52fb9f55=""
                                                                            ...
                                                                            <div className=" k-toggle ma-auto">
                                                                                <input id="object-12" label=""
                                                                                    type="checkbox" />
                                                                                <label for="object-12" className="colorone--text tw-text-xs">
                                                                                    Any Heart Condition</label>
                                                                                <div
                                                                        ...
                                                                        <div data-v-52fb9f55=""
                                                                            ...
                                                                            <div className=" k-toggle ma-auto">
                                                                                <input id="object-13" label=""
                                                                                    type="checkbox" />
                                                                                <label for="object-13" className="colorone--text tw-text-xs">
                                                                                    Any Operations</label>
                                                                                <div
                                                                                    className="k-toggle__track colorOne--text">
                                                                                </div>
                                                                                <div className="k-toggle__dot"
