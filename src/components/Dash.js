                        ...
                        <div>
                            ...
                            <div className="container grid-gap-earth">
                                            ...
                                            <div data-v-525699db className="layout row wrap cols-1">
                                                <div data-v-5478fe30 className="flex xs1">
                                                        ...
                                                        <div className="k-card__content">
                                                                ...
                                                                <p className="colorOneText">Lorem ipsum dolor sit amet,
                                ...
                                <div className="flex xs12 md6 order-xs3 order-md2">
                                            ...
                                            <div className="VueCarousel-inner"
                                                ...
                                                <div data-v-81efa066 tabindex="-1" role="tabpanel"
                                                    ...
                                                    <div data-v-81efa066 className="cta-container center-cta"
                                                        ...
                                                        <div className="layout main-content pa-saturn row wrap">
                                                            <div className="flex tw-flex flex-column xs6 hidden-xs-only">
                                                                <div className="cta-header">
                                                                    <img
                                                                        src="/3/img/headline-subhead.66bc8a5d.png"
                                                                        style={{
                                                                            "max-width": "100%",
                                                                            "height": "auto"
                                                                        }} />
                                                ...
                                                <div data-v-81efa066 tabindex="-1" role="tabpanel"
                                                    ...
                                                    <div data-v-81efa066 className="cta-container center-cta"
                                                        ...
                                                        <div className="layout main-content pa-saturn row wrap">
                                                            <div className="flex tw-flex flex-column xs6 hidden-xs-only">
                                                                <div className="cta-header">
                                                                    <h2 className="canon cta-title">
                                                                        MyFitnessPal</h2>
                                                                </div>
                                                                    <div className="cta-content">
                                                                    <div className="content-container mb-earth">
                                                                        <p className="mb-moon great-primer"
                                                                            style={{ "color": "rgb(189, 189, 189)" }}>Give your
                                                                            clients more freedom when tracking their
                                                                            nutrition with the new MyFitnessPal
                                                                                integration.<br />AVAILABLE NOW</p>
                                                                        </div>
                                                                </div>
                                                            </div>
                                                            <div className="flex text-md-right d-flex align-center xs6 hidden-xs-only"
                                                            ...
                                                            <div
                                                                className="flex content-center-container text-xs-center xs12 hidden-sm-and-up">
                                                                <h2 className="canon cta-title text-xs-center mb-mars">
                                                                        MyFitnessPal</h2>
                                                                    <div className="cta-content">
                                                                    <div className="content-container mb-earth">
                                                                        <p className="mb-earth great-primer">Give your
                                                                            clients more freedom when tracking their
                                                                            nutrition with the new MyFitnessPal
                                                                                integration.<br /> AVAILABLE NOW</p>
                                                                        </div>
                                                                    <div
                                                                        className="flex tw-flex tw-justify-center text-xs-center pt-earth xs12 hidden-sm-and-up">
                                                                        <img src="/3/img/Mfp.07b50869.png"
                                                                            style={{
                                                                                "max-width": "100%",
                                                                                    "height": "auto"
                                                                                }} />
                                                ...
                                                <div data-v-81efa066 tabindex="-1" role="tabpanel"
                                                    ...
                                                    <div data-v-81efa066 className="cta-container center-cta"
                                                        ...
                                                        <div className="background-image hidden-xs-only"
                                                            style={{
                                                                "background-image": "url(&quot;/3/img/MPTH101_Banner_BG.7ba98a96.png&quot)",
                                                                "background-repeat": "no-repeat",
                                                        ...
                                                        <div className="background-image hidden-sm-and-up"
                                                            style={{
                                                                "background-image": "url(&quot;/3/img/mob_BG.67156079.png&quot;)",
                                                                "background-repeat": "no-repeat",
                                                                "background-position": "right top",
                                                                "background-size": "cover"
                                                            }}>
                                    ...
                                    <div>
                                        <div className="dashboard-activity-feed-header k-card raised">
                                            <div className="k-card__content">
                                                <div className="k-row thin">
                                                        ...
                                                        <div className="d-flex pica">
                                                            <div className="modal-top">
                                                                <div className="layout row wrap">
                                                                    <div className="flex xs12 md11">
                                                                        <div className="double-pica">
                                                                        </div>
                                                                    </div>
                                                                    <div
                                                                        className="flex d-flex justify-end align-center xs12 md1">
                                                                        <div className="k-badge">
                                                                            <div className="k-badge__overlay"
                                                                                style={{
                                                                                    "top": "5px",
                                                                                    "right": "5px"
                                                                                }}>
                                                                                <div className="k-counter brevier" >
                                                                                            <div className="k-counter__value colorTwo">1</div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                        ...
                                                        <div className="k-title__subtitle-wrapper long-primer">
                                                            <span className="">
                                                            </span>
                                                        </div>
                                                    </span>
