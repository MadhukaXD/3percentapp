...
function ExerciseList() {
    ...
    return (
                                                        ...
                                                        <div data-v-12e8f0c3="" data-v-19d24620=""
                                                            ...
                                                            <div className="k-row__slot--middle">
                                                                <NavLink
                                                                    strict
                                                                    exact
                                                                    to={"editexercise?ExerciseList_id=" + ExerciseList._id}
                                                                >
        ...
        // <Container>
        //     <Container1>
        //         <input className="row" type="text" placeholder="Search your Exercise" />
        ...
        //         </div>
        //         {ExerciseList.map((ExerciseList, key) => (
        //             <a href={"editexercise?ExerciseList_id=" + ExerciseList._id}>
        //                 <div className="row">
        //                     <div className="col-md-6">
        //                         <h6>{ExerciseList.ExerciseTitle}</h6>
        //                     </div>
        //                     <div className="col-md-2">
        //                         <h6>{ExerciseList.Type}</h6>
        //                     </div>
        //                     <div className="col-md-2">

        //                     </div>
        //                     <div className="col-md-2">
        //                         <h6>{ExerciseList.Date}</h6>
        //                     </div>
        //                 </div>
        //             </a>
        //         ))}
